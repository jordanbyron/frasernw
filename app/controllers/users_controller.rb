    ...
    if params.blank? || params[:user].blank?
      ...
      if @user.present?
        if @user.update_attributes(params[:user])
          redirect_to login_url, :notice  => "Your account has been set up; please log in using your chosen e-mail address and newly created password. Welcome to Pathways!"
        else
