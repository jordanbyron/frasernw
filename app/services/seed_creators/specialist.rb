module SeedCreators
  class Specialist < SeedCreator::HandledTable
    Handlers = {
      ...
      practise_limitations: Proc.new{ "Not wheelchair accessible" },
      interest: Proc.new{ "Post-surgical Counselling" },
      created_at: :pass_through,
      updated_at: :pass_through,
      direct_phone_old: Proc.new{ Faker::PhoneNumber.phone_number },
      ...
      patient_can_book_old: :pass_through,
      ...
      referral_form_old: :pass_through,
