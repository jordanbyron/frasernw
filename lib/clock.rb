...
include Clockwork
  ...
  #  SubscriptionWorker.delay.mail_notifications_for_interval(Subscription::INTERVAL_MONTHLY)
  # end
  ...
  Clockwork.every(
    ...
    SubscriptionWorker.delay.mail_notifications_for_interval(Subscription::INTERVAL_DAILY)
  end
  ...
  Clockwork.every(
    ...
    SubscriptionWorker.delay.mail_notifications_for_interval(Subscription::INTERVAL_WEEKLY)
  end
