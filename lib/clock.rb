...
every(1.day, 'heroku restart', at: '13:00',  tz: 'UTC') { `heroku restart` }
...
Clockwork.every(
  ...
  SubscriptionWorker.
    delay.
    mail_notifications_for_interval(Subscription::INTERVAL_DAILY)
end
...
Clockwork.every(
  ...
  SubscriptionWorker.
    delay.
    mail_notifications_for_interval(Subscription::INTERVAL_WEEKLY)
end
